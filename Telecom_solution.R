...
# Loading 3 files
churn_data<- read.csv("F:/Rachita All Docs/Data Science Stuff/Class Material/Marsian/Project/Telecom Churn/churn_data.csv", stringsAsFactors = F)
customer_data<- read.csv("F:/Rachita All Docs/Data Science Stuff/Class Material/Marsian/Project/Telecom Churn/customer_data.csv", stringsAsFactors = F)
internet_data<- read.csv("F:/Rachita All Docs/Data Science Stuff/Class Material/Marsian/Project/Telecom Churn/internet_data.csv", stringsAsFactors = F)
